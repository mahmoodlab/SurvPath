...
do
    ...
    MODEL="deepmisl_wsi" # what type of model do you want to train?
    ...
    # DEEPMISL WSI + Pathways (Concat)
    MODEL="deepmisl_wsi_pathways" # what type of model do you want to train?
    ...
    # DEEPMISL WSI + Pathways (Bilinear fusion)
    TYPE_OF_PATH="combine" # what type of pathways? 
    MODEL="deepmisl_wsi_pathways" # what type of model do you want to train?
