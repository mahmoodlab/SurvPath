...
do
    ...
    MODEL="transmil_wsi" # what type of model do you want to train?
    ...
    # Transmil WSI + Pathways (Concat)
    TYPE_OF_PATH="combine" # what type of pathways? 
    MODEL="transmil_wsi_pathways" # what type of model do you want to train?
    ...
    # Transmil WSI + Pathways (Bilinear fusion)
    TYPE_OF_PATH="combine" # what type of pathways? 
    MODEL="transmil_wsi_pathways" # what type of model do you want to train?
